...
-- MSC & Co - Complete Database Design (SYNTAX FIXED)
-- ==========================================

-- ==========================================
-- 1. ENUM TYPES (COMPLETE SET)
-- ==========================================
...
CREATE UNIQUE INDEX idx_asset_revenue_unique_report 
ON asset_revenue(asset_id, platform, revenue_date, reporting_period_start);
...
SELECT 'COMPLETE MONOLITHIC DATABASE BUILD FINISHED' as status;
