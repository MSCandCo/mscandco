...
// Test Users Configuration (for Strapi)
const TEST_USERS = [
  // SUPER ADMIN USER
  {
    username: 'superadmin',
...
async function main() {
  console.log('🚀 Starting MSC & Co Strapi Test Data Setup...\n');
  ...
  try {
    ...
    console.log('\n🎉 Strapi test data setup complete!');
    console.log('\n📋 Test Users Created:');
    ...
    console.log('\n📝 Next Steps:');
    console.log('  1. Create Auth0 users manually in Auth0 dashboard');
    console.log('  2. Test login with the created users');
    console.log('  3. Explore the rich test data in Strapi admin');
