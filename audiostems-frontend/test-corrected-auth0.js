// Test Corrected Auth0 Configuration
const https = require('https');

console.log('=== Testing Corrected Auth0 Configuration ===');

// Test the corrected Auth0 domain
const domain = 'dev-x2t2bdk6z050yxkr.auth0.com';
  ...
  res.on('end', () => {
    if (res.statusCode === 200) {
      try {
        ...
        // Test the authorization endpoint with correct redirect URI
        ...
        console.log('✅ Auth0 configuration is ready for login!');
