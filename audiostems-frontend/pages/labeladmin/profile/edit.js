...
export default function EditProfile() {
  ...
  const LOCKED_FIELDS = ['first_name', 'last_name', 'email', 'country', 'city'];
  
  // EDITABLE: Can change directly
  const EDITABLE_FIELDS = ['label_name', 'company_name', 'phone', 'website', 'business_type', 'bio'];
  ...
  return (
    <Layout>
      <div className="max-w-5xl mx-auto p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Label Admin Profile</h1>
          <p className="text-gray-600 mt-2">Manage your label information and business details</p>
        </div>
              ...
              <div key={field}>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder={field === 'website' ? 'https://yourlabel.com' : field === 'phone' ? '+1 (555) 123-4567' : ''}
                  />
        ...
        <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Label Biography</h3>
          
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">About Your Label</label>
            <textarea
              value={editing.bio !== undefined ? editing.bio : profile?.bio || ''}
              onChange={(e) => handleEdit('bio', e.target.value)}
              rows={6}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="Tell the story of your label, your mission, and what makes your artists special..."
            />
