...
export default async function handler(req, res) {
  ...
  try {
    ...
    const backendResponse = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/export/creations/pdf`, {
      method: 'POST',
      headers: {
    ...
    res.setHeader('Content-Disposition', 'attachment; filename="msc-creations-export.pdf"');
