...
import { CreditCard, Wallet, Settings, RefreshCw, AlertCircle } from 'lucide-react';
...
export default function BillingPage() {
  ...
  useEffect(() => {
    if (!isLoading && user) {
      ...
      // Only artists and label admins have billing
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Manage your {isArtist ? 'artist' : 'label admin'} subscription and wallet
              </p>
            </div>
            <button
