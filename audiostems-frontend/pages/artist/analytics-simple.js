      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">
            Detailed analytics and insights will be available once you start releasing music through the platform.
          </p>
          <div className="text-sm text-gray-500">
            Track streams, revenue, audience demographics, and more when your releases go live.
          </div>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="text-center text-gray-500 py-8">
              ...
              Audience demographics will appear here
            </div>
          </div>
        </div>
      </div>
