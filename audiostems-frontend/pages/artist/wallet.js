    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{background: 'linear-gradient(180deg, #f9fafb 0%, #ffffff 100%)'}}>
        <div className="text-center">
          ...
          <p style={{color: '#64748b'}}>Loading your wallet...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{background: 'linear-gradient(180deg, #f9fafb 0%, #ffffff 100%)'}}>
        <div className="text-center p-8 bg-white rounded-2xl shadow-lg border border-red-200">
          ...
          <h2 className="text-xl font-bold mb-2" style={{color: '#991b1b'}}>Error Loading Wallet</h2>
          <p className="mb-4" style={{color: '#64748b'}}>{error || 'Unable to load wallet data'}</p>
          <button
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-xl text-white max-w-3xl">
                Manage your earnings, track payments, and request payouts
              </p>
            </div>
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <a
                ...
                className="flex items-center space-x-2 px-4 py-2 text-white rounded-lg text-sm font-medium transition-all"
                style={{background: 'linear-gradient(135deg, #1f2937 0%, #374151 100%)'}}
              >
                  ...
                  <div className="flex items-center justify-end space-x-1">
                    {entry.status === 'paid' ? (
                      <>
                        ...
                        <span className="text-sm font-medium" style={{color: '#065f46'}}>Paid</span>
                      </>
                    ) : (
                      <>
                        <Clock className="w-3 h-3" style={{color: '#d97706'}} />
