...
export default function ArtistPortalOverview() {
  ...
  return (
    <>
      <Head>
        <title>Artist Portal Overview - AudioStems</title>
      </Head>
            ...
            <ol className="flex items-center space-x-4">
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-4 text-gray-500">Artist Portal</span>
                </div>
              </li>
            </ol>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3">
              <div className="bg-white rounded-lg shadow-sm p-6">
                <h2 className="text-xl font-semibold text-gray-900 mb-6">Artist Portal Overview</h2>
                
                {/* Welcome Section */}
                <div className="mb-8">
                  <h3 className="text-lg font-medium text-gray-900 mb-2">
                    Welcome back, {userProfile?.stageName || userProfile?.firstName || user?.name || 'Artist'}!
                  </h3>
                  <p className="text-gray-600">
                    Manage your music distribution, track your performance, and access your artist tools all in one place.
                  </p>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <Link href="/distribution/publishing/artist-portal/royalties" className="block p-4 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-colors">
                      <div className="flex items-center">
                        <div className="flex-shrink-0">
                          <svg className="h-6 w-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="ml-3">
                        <p className="text-sm text-gray-900">New release "Midnight Dreams" published to all platforms</p>
                    ...
                    <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="ml-3">
                        <p className="text-sm text-gray-900">New follower milestone reached: 25K followers</p>
