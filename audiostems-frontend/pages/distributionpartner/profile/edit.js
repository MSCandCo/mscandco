...
export default function EditProfile() {
  ...
  const EDITABLE_FIELDS = ['company_name', 'partner_type', 'distribution_channels', 'phone', 'website', 'bio'];
  ...
  return (
    <Layout>
      <div className="max-w-5xl mx-auto p-8">
        ...
        {/* Distribution Information - EDITABLE */}
        <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
          <div className="flex items-center mb-4">
            <Edit className="w-5 h-5 text-blue-600 mr-2" />
            <h2 className="text-xl font-semibold text-gray-900">Distribution Information</h2>
          </div>
              ...
              <div key={field}>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder={
                      field === 'website' ? 'https://yourdistribution.com' : 
                      field === 'phone' ? '+1 (555) 123-4567' : 
                      field === 'distribution_channels' ? 'Spotify, Apple Music, etc.' : 
                      field === 'partner_type' ? 'Digital, Physical, Both' : ''
                    }
                  />
        ...
        <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Partner Biography</h3>
          
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">About Your Distribution Services</label>
            <textarea
              value={editing.bio !== undefined ? editing.bio : profile?.bio || ''}
              onChange={(e) => handleEdit('bio', e.target.value)}
              rows={6}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="Describe your distribution services, expertise, and what you offer to artists and labels..."
            />
