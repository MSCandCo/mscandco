...
import { Lock, Edit, Save, X, Upload, User, Mail, Phone, Globe, Calendar, MapPin, Building, Award, FileText, Truck } from 'lucide-react';
...
export default function DistributionPartnerProfile() {
  ...
  const validateFields = () => {
    const newErrors = {};
    const requiredFields = ['company_name', 'partner_type'];
  ...
  const calculateProgress = () => {
    ...
    const allFields = [
      'first_name', 'last_name', 'email', 'company_name', 'partner_type', 'territory', 'date_of_birth', 'nationality', 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage your partner information and settings</p>
            </div>
              ...
              <section className="bg-gray-100 rounded-xl shadow-sm border border-gray-300 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="mb-4">
                    <label className="flex items-center text-sm font-medium text-gray-700 mb-2">
                      Partner Type *
                      {changedFields.includes('partner_type') && (
                        <span className="ml-2 text-green-600">✓</span>
                      )}
                    </label>
                    <select
                      value={editedProfile.partner_type || ''}
                      onChange={(e) => handleFieldChange('partner_type', e.target.value)}
                      disabled={!editMode}
                      className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                        !editMode ? 'bg-gray-50 cursor-not-allowed' : 'bg-white'
                      } ${errors.partner_type ? 'border-red-500' : 'border-gray-300'}`}
                    >
                    ...
                    {errors.partner_type && (
                      <p className="text-red-500 text-sm mt-1">{errors.partner_type}</p>
                    )}
                  </div>
                  ...
                  <div>
                    <label className="flex items-center text-sm font-medium text-gray-700 mb-2">
                      Territory
                      {changedFields.includes('territory') && (
                        <span className="ml-2 text-green-600">✓</span>
                      )}
                    </label>
                    <input
                      type="text"
                      value={editedProfile.territory || ''}
                  ...
                  <div>
                    <label className="flex items-center text-sm font-medium text-gray-700 mb-2">
                      Partnership Level
                      {changedFields.includes('partnership_level') && (
                        <span className="ml-2 text-green-600">✓</span>
                      )}
                    </label>
                    <input
                      type="text"
                      value={editedProfile.partnership_level || ''}
                      onChange={(e) => handleFieldChange('partnership_level', e.target.value)}
                      disabled={!editMode}
                      className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                        !editMode ? 'bg-gray-50 cursor-not-allowed' : 'bg-white'
                      } border-gray-300`}
              ...
              <section className="bg-gray-100 rounded-xl shadow-sm border border-gray-300 p-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Tell us about your distribution company and services..."
                  />
                </div>
              </section>
            ...
            <div className="space-y-6">
              ...
              <section className="bg-gray-100 rounded-xl shadow-sm border border-gray-300 p-6">
                ...
                <p className="text-sm text-gray-600">
                  Complete your profile to access all distribution partner features.
                </p>
              </section>
