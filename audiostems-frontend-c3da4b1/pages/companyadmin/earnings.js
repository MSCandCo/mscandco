...
export default function CompanyAdminEarnings() {
  ...
  // Clean earnings data - ground zero state
  const [earningsData] = useState({
    ...
    // Empty asset earnings - will be populated from real data
    assetEarnings: [],

    // Empty monthly earnings trend - will be populated from real data
    monthlyTrend: [
      { month: 'Jul 2023', earnings: 0 },
      { month: 'Aug 2023', earnings: 0 },
      { month: 'Sep 2023', earnings: 0 },
      { month: 'Oct 2023', earnings: 0 },
      { month: 'Nov 2023', earnings: 0 },
      { month: 'Dec 2023', earnings: 0 },
      { month: 'Jan 2024', earnings: 0 }
    ],

    // Empty platform performance - will be populated from real data
    platformBreakdown: {
      spotify: { earnings: 0, percentage: 0 },
      appleMusic: { earnings: 0, percentage: 0 },
      youtube: { earnings: 0, percentage: 0 },
      amazonMusic: { earnings: 0, percentage: 0 }
    }
  });
