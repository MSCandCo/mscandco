...
function AdminAnalytics() {
  ...
  const mockPlatformStats = [
    { platform: 'Spotify', totalStreams: 0, totalEarnings: 0, avgCompletionTime: 28, releases: 45 },
    { platform: 'Apple Music', totalStreams: 0, totalEarnings: 0, avgCompletionTime: 32, releases: 42 },
    { platform: 'YouTube Music', totalStreams: 0, totalEarnings: 0, avgCompletionTime: 35, releases: 38 },
    { platform: 'Amazon Music', totalStreams: 0, totalEarnings: 0, avgCompletionTime: 30, releases: 35 },
    { platform: 'Deezer', totalStreams: 0, totalEarnings: 0, avgCompletionTime: 25, releases: 28 },
    { platform: 'Tidal', totalStreams: 0, totalEarnings: 0, avgCompletionTime: 22, releases: 22 },
    { platform: 'Pandora', totalStreams: 0, totalEarnings: 0, avgCompletionTime: 24, releases: 18 },
    { platform: 'SoundCloud', totalStreams: 0, totalEarnings: 0, avgCompletionTime: 20, releases: 15 },
    { platform: 'Bandcamp', totalStreams: 0, totalEarnings: 0, avgCompletionTime: 18, releases: 12 },
    { platform: 'Other Platforms', totalStreams: 0, totalEarnings: 0, avgCompletionTime: 27, releases: 85 }
  ];

  const allUserStats = [
    { id: 1, name: 'YHWH MSC', role: 'artist', status: 'active', releases: 6, totalEarnings: 0, avgFormTime: 18, efficiency: 92 },
    { id: 2, name: 'Global Superstar', role: 'artist', status: 'active', releases: 3, totalEarnings: 0, avgFormTime: 11, efficiency: 95 },
    { id: 3, name: 'Seoul Stars', role: 'artist', status: 'active', releases: 2, totalEarnings: 0, avgFormTime: 28, efficiency: 78 },
    { id: 4, name: 'Rock Legends', role: 'artist', status: 'active', releases: 1, totalEarnings: 0, avgFormTime: 8, efficiency: 98 },
    { id: 5, name: 'Carlos Mendez', role: 'artist', status: 'active', releases: 1, totalEarnings: 0, avgFormTime: 22, efficiency: 85 },
    { id: 6, name: 'DJ Phoenix', role: 'artist', status: 'pending', releases: 0, totalEarnings: 0, avgFormTime: 0, efficiency: 0 },
    { id: 7, name: 'Miami Bass', role: 'artist', status: 'active', releases: 1, totalEarnings: 0, avgFormTime: 15, efficiency: 88 },
    { id: 8, name: 'Electronic Fusion', role: 'artist', status: 'active', releases: 1, totalEarnings: 0, avgFormTime: 19, efficiency: 87 },
    ...
    { id: 12, name: 'YHWH Label Admin', role: 'label_admin', status: 'active', releases: 12, totalEarnings: 0, avgFormTime: 14, efficiency: 91 },
    { id: 13, name: 'Urban Sounds Label Admin', role: 'label_admin', status: 'active', releases: 8, totalEarnings: 0, avgFormTime: 16, efficiency: 89 }
  ];
