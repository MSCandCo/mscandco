...
function AdminContent() {
  ...
  const mockArtists = [
    { id: 1, name: 'YHWH MSC', genre: 'Hip Hop', songs: 6, totalStreams: 0, status: 'active', label: 'MSC & Co' },
    { id: 2, name: 'Global Superstar', genre: 'Pop', songs: 3, totalStreams: 0, status: 'active', label: 'Major Label Music' },
    { id: 3, name: 'Seoul Stars', genre: 'Pop', songs: 3, totalStreams: 0, status: 'active', label: 'K-Entertainment' },
    { id: 4, name: 'Rock Legends', genre: 'Rock', songs: 3, totalStreams: 0, status: 'active', label: 'Live Music Records' },
    { id: 5, name: 'DJ Phoenix', genre: 'Electronic', songs: 4, totalStreams: 0, status: 'pending', label: 'Digital Beats' },
    { id: 6, name: 'Carlos Mendez', genre: 'Latin', songs: 1, totalStreams: 0, status: 'active', label: 'Latin Beats Records' },
