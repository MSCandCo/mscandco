...
# AudioStems AWS Database Deployment Script
# This script automates the deployment of the AWS RDS PostgreSQL database
...
show_monitoring() {
    ...
    echo "- Read/Write IOPS"
    echo ""
}

# Main deployment function
deploy() {
    log "Starting AudioStems database deployment..."
...
# Show help
show_help() {
    echo "AudioStems AWS Database Deployment Script"
    echo ""
