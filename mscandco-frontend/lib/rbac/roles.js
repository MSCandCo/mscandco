...
export const PERMISSIONS = {
  ...
  'notification:view:own': [ROLES.ARTIST, ROLES.LABEL_ADMIN, ROLES.COMPANY_ADMIN, ROLES.SUPER_ADMIN, ROLES.DISTRIBUTION_PARTNER],
  'notification:manage:own': [ROLES.ARTIST, ROLES.LABEL_ADMIN, ROLES.COMPANY_ADMIN, ROLES.SUPER_ADMIN, ROLES.DISTRIBUTION_PARTNER],
