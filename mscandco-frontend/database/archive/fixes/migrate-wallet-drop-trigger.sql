-- ============================================================================
-- WALLET SYSTEM MIGRATION: Drop problematic trigger first
-- ============================================================================
-- The split_earnings_for_affiliations trigger is causing issues
-- We'll drop it, do the migration, then you can recreate it later if needed
-- ============================================================================

-- Step 1: Drop the problematic trigger
DROP TRIGGER IF EXISTS split_earnings_trigger ON earnings_log;

-- Step 2: Migrate existing wallet balances to earnings_log
...
-- Step 4: Create view for quick balance lookups
...
SELECT 
  COUNT(DISTINCT artist_id) as users_migrated,
  SUM(amount) as total_amount_migrated,
...
-- NOTES
-- ============================================================================
-- The split_earnings_trigger has been dropped because it requires a 
-- shared_earnings table that doesn't exist yet.
--
-- If you need the splits functionality later, you'll need to:
-- 1. Create the shared_earnings table
-- 2. Recreate the trigger
--
-- For now, the wallet system will work without automatic splits.
-- ============================================================================
