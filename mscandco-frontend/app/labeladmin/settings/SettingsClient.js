...
const LabelAdminSettingsClient = () => {
  ...
  const loadAllSettings = async () => {
    ...
    try {
      // Load preferences
      const prefsResponse = await fetch('/api/labeladmin/settings/preferences', {
        credentials: 'include'
      });
      if (prefsResponse.ok) {
      ...
      const notifResponse = await fetch('/api/labeladmin/settings/notifications', {
        credentials: 'include'
      });
      if (notifResponse.ok) {
      ...
      // Load security data
      const securityResponse = await fetch('/api/labeladmin/settings/security', {
        credentials: 'include'
      });
      ...
      // Load billing data
      const billingResponse = await fetch('/api/labeladmin/settings/billing', {
        credentials: 'include'
      });
      ...
      // Load API key data
      const apiResponse = await fetch('/api/labeladmin/settings/api-key', {
        credentials: 'include'
      });
      if (apiResponse.ok) {
  ...
  const savePreferences = async () => {
    setIsSaving(true);
    try {
      const response = await fetch('/api/labeladmin/settings/preferences', {
        method: 'POST',
        headers: {
  ...
  const saveNotifications = async () => {
    setIsSaving(true);
    try {
      const response = await fetch('/api/labeladmin/settings/notifications', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const changePassword = async () => {
    ...
    setIsSaving(true);
    try {
      const response = await fetch('/api/labeladmin/settings/security', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const regenerateApiKey = async () => {
    ...
    setIsSaving(true);
    try {
      const response = await fetch('/api/labeladmin/settings/api-key', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">Manage your label admin preferences and settings</p>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          {/* Tab 1: Platform Preferences (with Email Signature) */}
          <TabsContent value="preferences" className="space-y-6">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                ...
                {/* Email Signature (Label Admin specific) */}
                <div>
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-500">
                        Display Open Data link in the main navigation header for accessing open music industry data
                      </p>
                    </div>
                    <button
                      type="button"
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <label className="block text-sm font-medium text-gray-900 mb-1">
                        Show Sustainability Link
                      </label>
                      <p className="text-sm text-gray-500">
                        Display Sustainability link in navigation for tracking environmental impact
                      </p>
                    </div>
                    <button
                      type="button"
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <label className="block text-sm font-medium text-gray-900 mb-1">
                        Show Lyrics Analysis Link
                      </label>
                      <p className="text-sm text-gray-500">
                        Display Lyrics Analysis link in navigation for analyzing and improving lyrics
                      </p>
                    </div>
                    <button
                      type="button"
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-500">
                        Display Copyright link in navigation for managing rights and clearances
                      </p>
                    </div>
                    <button
                      type="button"
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-500">
                        Display Learning link in navigation for accessing courses and educational content
                      </p>
                    </div>
                    <button
                      type="button"
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-500">
                        Display Touring link in navigation for managing tours, dates, crew, and tour logistics
                      </p>
                    </div>
                    <button
                      type="button"
          ...
          {/* Tab 2: Notifications (Label Admin specific) */}
          <TabsContent value="notifications" className="space-y-6">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                ...
                {/* Notification Preferences (Label Admin specific) */}
                <div className="pt-4">
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center">
                      <input
                        ...
                        onChange={(e) => setNotifications(prev => ({ ...prev, artistUpdates: e.target.checked }))}
                        className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                      />
                      <span className="ml-2 text-sm text-gray-700">Artist updates and submissions</span>
                    </label>

                    <label className="flex items-center">
                      <input
                        type="checkbox"
                        checked={notifications.releaseApprovals}
                        onChange={(e) => setNotifications(prev => ({ ...prev, releaseApprovals: e.target.checked }))}
                        className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                      />
                      <span className="ml-2 text-sm text-gray-700">Release approval requests</span>
                    </label>
                    ...
                    <label className="flex items-center">
                      <input
                        ...
                        onChange={(e) => setNotifications(prev => ({ ...prev, revenue: e.target.checked }))}
                        className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                      />
                      <span className="ml-2 text-sm text-gray-700">Revenue and earnings reports</span>
                    </label>
                    ...
                    <label className="flex items-center">
                      <input
                        ...
                        className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                      />
                      <span className="ml-2 text-sm text-gray-700">New messages from artists</span>
                    </label>
                  </div>
                </div>
                ...
                {billing.currentPlan ? (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <div className="mt-4 pt-4 border-t border-blue-200">
                      <Button
                        onClick={() => router.push('/labeladmin/billing')}
                        variant="outline"
                        className="w-full"
                      >
                        Manage Subscription
          ...
          {/* Tab 5: API Access (same as Artist) */}
