/**
 * Find My Song Page - App Router Version
 *
 * Public page for song request form
 */
'use client'
...
export default function FindMySongPage() {
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="min-h-screen flex items-center justify-center px-4">
          <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-lg text-center">
            ...
            <button
              onClick={() => router.push('/')}
              className="w-full bg-transparent text-[#1f2937] border border-[#1f2937] rounded-xl px-6 py-3 font-bold shadow transition-all duration-300 hover:bg-[#1f2937] hover:text-white hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-[#1f2937]"
            >
              Return to Home
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between pt-4">
              ...
              <button
                ...
                className="bg-transparent text-[#1f2937] border border-[#1f2937] rounded-xl px-8 py-2 font-bold shadow transition-all duration-300 hover:bg-[#1f2937] hover:text-white hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-[#1f2937] disabled:opacity-50"
              >
