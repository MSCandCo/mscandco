/**
 * Support Page - App Router Version
 *
 * Public page for support and contact information
 */
'use client'
        ...
        {activeTab === 'faq' && (
          <div className="space-y-6">
            ...
            <div className="mt-8 text-center">
              <Link
                href="/faq"
                className="text-[#166534] hover:text-green-900 font-semibold"
              >
                View All FAQs →
              </Link>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-lg border p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="bg-transparent text-[#1f2937] border border-[#1f2937] rounded-xl px-6 py-2 font-bold shadow transition-all duration-300 hover:bg-[#1f2937] hover:text-white hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-[#1f2937]"
                >
                  Submit Ticket
                </button>
              </form>
